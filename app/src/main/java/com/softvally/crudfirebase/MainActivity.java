package com.softvally.crudfirebase;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void editNotes(Notes notes) {
        showDialogEditData(notes);

    }

    private void showDialogEditData(Notes notes) {
        ...
        editText.setText(notes.getText());
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(editText.getText())) {
                    ...
                    uddateData(notes,editText.getText().toString());
                    dialog.dismiss();
    ...
    private void uddateData(Notes notes,String newText) {
        ...
        myRef.child(notes.getId()).child("text").setValue(newText).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(MainActivity.this, "Udated successfully", Toast.LENGTH_SHORT).show();
